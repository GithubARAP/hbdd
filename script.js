...
document.querySelectorAll(".button").forEach((button) => {
  button.addEventListener("click", function () {
    ...
    switch (this.id) {
      case "button1":
        newText = "semoga sayang aku terus"; // Ganti dengan teks yang diinginkan untuk button1
        break;
      case "button2":
        newText = "semoga cinta aku terus"; // Ganti dengan teks yang diinginkan untuk button2
        break;
      case "button3":
        newText = "semoga ga bosen sama aku"; // Ganti dengan teks yang diinginkan untuk button3
        break;
      case "button4":
        newText = "semoga kita bersama terus"; // Ganti dengan teks yang diinginkan untuk button4
        break;
      default:
